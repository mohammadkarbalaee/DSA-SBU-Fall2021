...
double getMedian(int e, double &m, Heap &l, Heap &r)
{
    ...
    // double temporary = Average((double)l.GetTop(), (double)r.GetTop());
    // cout << fixed << setprecision(1) << "reulst of average:    " << temporary << endl;
		m = Average((double)l.GetTop(), (double)r.GetTop());
