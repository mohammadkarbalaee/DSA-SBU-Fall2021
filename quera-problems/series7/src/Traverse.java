...
//    int n = input.nextInt();
//    for (int i = 0; i < n; i++) {
//      myBST.insert(input.nextInt());
//    }
////    ArrayList<Integer> inorderWalkResult = myBST.getSortedData();
////    for (int i = 0; i < n; i++) {
////      System.out.print(inorderWalkResult.get(i) + " ");
////    }
//    myBST.inorderTreeWalk(myBST.treeSearch(myBST.getRootNode(),4));
//    System.out.println(myBST.getInorderWalkResult());
//  }
//}
//
///**
